# A tool by SYED from SYED RAHIM.com
...
echo -e "$red                      ⫸$ylo  ALONE HACKER$red ⫷$rset"
echo 
# Functions
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn SYED RAHIM$red◀$rset"
echo -e "$red                      ⫸$ylo ALONE HACKER$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mSYED" | pv -qL 10
echo -e "\e[93m             IAM \e[92mSYED RAHIM" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.Syed Rahim.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Chamkani17> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
